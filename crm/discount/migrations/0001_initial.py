    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.IntegerField(choices=[(0, '注册送积分'), (1, '到访送积分'), (2, '问卷积分'), (3, '3D看房送积分'), (4, '签到送积分'), (5, '看样板房送积分'), (6, '活动扫码送积分1'), (7, '活动扫码送积分2'), (8, '活动扫码送积分3'), (9, '活动扫码送积分4'), (10, '活动扫码送积分5')], verbose_name='积分规则')),
                ...
                ('company_id', models.CharField(max_length=255, verbose_name='门店编码')),
            ],
            options={
                'verbose_name': '积分规则',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rule', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='discount.CoinRule', verbose_name='类型')),
            ],
            options={
                'verbose_name': '用户积分记录',
            },
