...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='sendcoupon',
            name='coupon',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='discount.Coupon',
                                    verbose_name='优惠券'),
        ),
        migrations.AddField(
            model_name='sendcoupon',
        ...
        migrations.AddField(
            ...
            name='rule',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL,
                                    to='discount.CoinRule', verbose_name='积分规则'),
        ),
        migrations.AddField(
            model_name='pointrecord',
            name='seller',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL,
                                    to=settings.AUTH_USER_MODEL, verbose_name='后台管理'),
        ),
        migrations.AddField(
            model_name='pointrecord',
            name='user',
        ...
        migrations.AddField(
            ...
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL,
                                       related_name='coin_rule', to='discount.CoinQRCode', verbose_name='二维码'),
        ),
